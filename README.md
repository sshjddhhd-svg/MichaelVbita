...
| `دراكاريس` | تشغيل الإرسال التلقائي بدون بادئة (أدمن) |
| `/صورة` | تغيير صورة المجموعة عبر الرد على صورة (أدمن) |
| `/صورةالبوت` | تغيير صورة حساب البوت عبر الرد على صورة (أدمن) |

> جميع الأوامر مقفلة للأدمنز فقط. الأدمن هو المالك أو من أضيف في `adminIDs` أو
> من تم رفعه بأمر `ارفع`. المستخدم غير المصرّح له لا يحصل على أي رد من البوت.
